...
//**************** 상수 ****************	
	...
	$username = "smartel";
	$password = "z73Ij7/stl+h6QmJoIQFSdrN0ZJK/34PxEKl1OLVad4=";
	
	$key = "SMARTEL^&)MOBILE143528$@MVNOHEMO";		//AES256-CBC 암호화 key
	
	$domain = $isDev == true ? "http://ohwm.whox2.co.kr:8259" : "https://smartel.whox2.co.kr:18259";
	// $domain = "http://ohwm.whox2.co.kr:8259";		//개발
	// $domain = "https://smartel.whox2.co.kr:18259";		//상용
...
//**************** 로그기록 ****************
	function log_exist($add_name){
		...
		$toDay = date("Ymd");
		$logFile = $toMon."/".$toDay.$add_name.".txt";
...
//**************** Curl ****************
//헤더
function rest_header() { 
	$headers = array('Content-Type: application/json; charset=utf-8');	
	return $headers;
}

function rest_header2($Authorization) { 
	$headers = array(
